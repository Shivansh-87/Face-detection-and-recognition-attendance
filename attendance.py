...
class Attendance:
    def __init__(self, root):
        ...
        second_lbl = Label(self.root, image=self.photoimg1)
        second_lbl.place(x=800, y=0, width=800, height=200)
        ...
        # Title Label
        title_lbl = Label(bg_img, text="ANNA!!! ATTENDANCE...", font=("times new roman", 35, "bold"), bg="white", fg="red")
        ...
        left_inside_frame.place(x=0,y=135,width=750,height=400)
...
# Attendance Status
        ...
        self.atten_status = ttk.Combobox(left_inside_frame, font=("times new roman", 12, "bold"),textvariable=self.var_atten_status, state="readonly", width=19)
        ...
        save_btn = Button(btn_frame, text="Import csv",command=importCsv, width=17, font=("times", 13, "bold"), bg="blue", fg="white")
        save_btn.grid(row=0, column=0)

        update_btn = Button(btn_frame, text="Export csv",command=exportCsv, width=18, font=("times", 13, "bold"), bg="blue", fg="white")
        update_btn.grid(row=0, column=1)

        delete_btn = Button(btn_frame, text="Update", width=18, font=("times", 13, "bold"), bg="blue", fg="white")
        ...
        table_frame.place(x=5, y=35, width=700, height=455)
